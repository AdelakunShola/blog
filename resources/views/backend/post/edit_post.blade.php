					...
					<div class="main-body">
						<div class="row">
							...
							<div class="card-body p-4">
                                ...
                                <form id="form" action="{{ route('update.blog.post') }}"  class="row g-3"  method="post"  enctype="multipart/form-data" >
                                            @csrf
                                ...
                                <div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<input type="text" name="post_title" class="form-control" id="input1" placeholder="First Name" value="{{ $post->post_title }}">
									</div>
