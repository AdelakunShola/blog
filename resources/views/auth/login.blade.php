                ...
                <div class="row align-items-center">
                    <div class="order-2 order-lg-1 col-lg-6 mt_md--40 mt_sm--40">
                        <div class="content">
                            ...
                            <form method="POST" action="{{ route('login') }}"   style="max-width: 800px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                                    @csrf
                            

                                <label for="username" style="display: block; margin-bottom: 10px; text-align: left;">Email / Username:</label>
                                <input type="text" id="login" name="login" style="width: 100%; padding: 8px; margin-bottom: 15px; box-sizing: border-box; border: 1px solid #ccc; border-radius: 4px;" required>
                                ...
                                <label for="remember_me" class="inline-flex items-center">
                                 ...
                                 <span class="ms-2 text-sm text-gray-600">{{ __('Remember me') }}</span>
                                    ...
                                    <a href="{{ route('password.request') }}" style="text-decoration: none; color: #333;">Forgot Password?</a>
                                </div>

                                <a href="{{ route('register') }}" style="text-decoration: none; color: #333;">register</a>
                    ...
                    <div class="order-1 order-lg-2 col-lg-5 offset-lg-1">
                        <div class="thumbnail">
                            <img src="{{asset('frontend/assets/images/post-images/gallery-post-01.jpg')}}" alt="Images">
                        </div>
                    </div>
                </div>
            </div>
